...
public sealed unsafe class NetworkPlayerMoveController : NetworkTRSP, INetworkTRSPTeleport, IBeforeAllTicks, IAfterAllTicks, IBeforeCopyPreviousState
{
    ...
    public void Move(Vector3 direction, float lookdirectionY)
    {
        ...
        else
        {
            ...
            {
                transform.rotation = Quaternion.Slerp(transform.rotation, Quaternion.Euler(new Vector3(0f, lookdirectionY, 0f)), rotationSpeed * Runner.DeltaTime);
            }
        }
